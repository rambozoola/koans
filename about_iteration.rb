...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # 
    # Puts its argument as a first parameter into the block and the item as the second parameter.
    # Repeats this for each item and uses the previous result as the next first parameter.
  end
